...
set_property PACKAGE_PIN G3 [get_ports nrth_pedo_button]
set_property IOSTANDARD LVCMOS33 [get_ports nrth_pedo_button]

set_property PACKAGE_PIN G2 [get_ports west_pedo_button]
set_property IOSTANDARD LVCMOS33 [get_ports west_pedo_button]
